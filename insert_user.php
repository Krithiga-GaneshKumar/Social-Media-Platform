...
if(isset($_POST['sign_up'])){
    ...
    ,user_image,user_cover,user_reg_date,status,post,recovery_account) values('$first_name','$last_name','$username','Hello','...','$pass','$email','$country','$gender','$birthday',
